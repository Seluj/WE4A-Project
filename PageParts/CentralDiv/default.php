<!-- PageParts/CentralDiv/default.php -->
<!-- Fichier contenant l'affichage par défaut lorsque que l'utilisateur arrive sur le site ou vient juste de se connecter -->
...
<div id="default_div">
    ...
    <!-- On affiche ensuite une liste de message -->
